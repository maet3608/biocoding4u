...
(function () {
    ...
    e = jQuery, D = 0, P = 1, H = 2, T = 13, O = 9, E = 46, w = 8, C = 37, A = 39, M = 38, S = 40, N = 36, x = 35, L = 33, k = 34, a = "jqconsole-", i = "" + a + "cursor", s = "" + a + "header", f = "" + a + "prompt", u = "" + a + "old-prompt", o = "" + a + "input", r = "" + a + "blurred", y = "keypress", v = "<span/>", p = "<div/>", d = ":empty", _ = "\n", h = ">>> ", c = "... ", l = 2, n = "" + a + "ansi-", m = "", g = /\[(\d*)(?:;(\d*))*m/, t = function () {
        ...
        return e.prototype.COLORS = ["black", "red", "green", "yellow", "blue", "magenta", "cyan", "white"], e.prototype._append = function (e) {
            ...
            while ((r = e.indexOf(m, r)) && r !== -1)if (n = e.slice(r).match(g)) {
                o = n.slice(1);
        ...
        return n.prototype.ResetHistory = function () {
            ...
            var r;
            return r = {opening_char:e, closing_char:t, cls:n}, this.matchings.clss.push(n), this.matchings.openings[e] = r, this.matchings.closings[t] = r
            ...
            var t, n;
            return t = this.$console.find("." + s).nextUntil("." + f), function () {
                var r, i, s;
                s = [];
            ...
            if (e.browser.mozilla)if (t.keyCode || t.altKey)return!0;
            ...
            var n, r, i, s, o, u, a, f;
            return s = t ? this.$prompt_left : this.$prompt_right, n = t ? this.$prompt_right : this.$prompt_left, i = t ? this.$prompt_before : this.$prompt_after, r = t ? this.$prompt_after : this.$prompt_before, u = t ? e.proxy(this.MoveToStart, this) : e.proxy(this.MoveToEnd, this), o = t ? e.proxy(this._MoveLeft, this) : e.proxy(this._MoveRight, this), f = t ? "last" : "first", a = t ? "prependTo" : "appendTo", {$prompt_which:s, $prompt_opposite:n, $prompt_relative:i, $prompt_rel_opposite:r, MoveToLimit:u, MoveDirection:o, which_end:f, where_append:a}
            ...
            var e;
            return e = this.$console[0].scrollTop - this.$console.height(), this.$console.stop().animate({scrollTop:e}, "fast")
            ...
            return this.$console.scrollTop(this.$console[0].scrollHeight), e = function () {
                var e, n, r, i, s, o, u;
                n = t.$prompt_cursor.height(), u = t.$window.scrollTop(), o = t.$window.scrollLeft(), e = document.documentElement.clientHeight, i = t.$prompt_cursor.offset(), s = t.$prompt_cursor.position(), t.$input_container.css({left:s.left, top:s.top}), r = i.top - 2 * n;
            ...
            while (s = u()) {
                s === t ? r++ : s === n && r--;
                if (r === 0)return{index:o, current_count:r}
            }
            return{index:-1, current_count:r}
